...
@app.post("/create_almacenes/", response_model=Almacen, status_code=status.HTTP_201_CREATED, tags=['ALMACEN'])
...
@app.post("/create_movimiento_insumos/", response_model=MovimientoInsumo, status_code=status.HTTP_201_CREATED, tags=['INSUMO']) # Se agregó
...
@app.post("/create_stock_almacen_insumos/", response_model=StockAlmacenInsumo, status_code=status.HTTP_201_CREATED, tags=['INSUMO']) # Se agregó
...
@app.get("/insumo/tipo_movimiento_insumos/", response_model=list[TipoMovimientoInsumo], tags=['INSUMO']) # Se agregó
